...
$slider			= new stdClass();
$slider->items  = $this->db->getAll("select title,tagline,description,image,btn_caption,url from ".$this->table_prefix."slider where publish='1' order by slider_order");
$slider->url 	= !$this->device->isMobile()?uploadURL.'modules/slider/':uploadURL.'modules/slider/thumbs/medium/';
$xgetSlider		= '';
$indicators		= '';
$sliderLength	= 0;
