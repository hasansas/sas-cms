...
$params = array(
	...
	$this->form->input->html('<input type="text" name="username" value="'.$username.'" disabled="disabled" class="form-control disabled">'),
	...
	$this->form->input->html('<input type="email" name="add_email" value="'.$email.'" class="form-control">'),
	$this->form->input->html('<hr>'),
	$this->form->input->html('</div>')
);
			...
			<form method="post" action="" name="frm_account">
				<div class="form-input">
					...
					<div class="form-input-bottom form-actions">
						...
						<button id="changepass" type="submit" name="changepass" class="btn btn-flat btn-primary"><i class="fa fa-save"></i>Save Changes</button>
					</div>
				</div>
			</form>
		</div>
