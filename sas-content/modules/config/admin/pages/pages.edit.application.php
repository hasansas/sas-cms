...
$this->form->onUpdate('updateTbl($this->db,$post,$this->table_prefix,$tableKey,$out)');

function updateTbl($db,$post,$table_prefix,$tableKey,$out){
