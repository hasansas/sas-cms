...
// Selet Page menu
$arrPageMenu = $this->db->getAll("select page_id from ".$this->table_prefix."menu where publish='1' and  admin_menu='".$adminMenu."' and position='".$activePosition."' and page_id<>'0'");
$pageMenu	 = array();
...
// Create categoy page
$pageName   = $this->site->isMultiLang()?'page_name_'.$this->active_lang():'page_name';
$getArrCategory = $this->db->getAll("select page_id,".$pageName." as page_name from ".$this->table_prefix."pages where publish='1' and category_id<>'0'".$adminOnly." order by ".$pageName);
