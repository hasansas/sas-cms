...
$help	= '<div class="help-container">
		...
		<div class="help-item">
			...
			<div class="help-content">
				<li>Rubah data <b>Label</b> menu dan icon menu sesuai yang diinginkan</li>
			</div>
		</div>
		<div class="help-item">
			<div class="help-title">Menyimpan data</div>
			<div class="help-content">
				<li>Jika sudah selesai mengedit data yang diinginkan, klik tombol <button class="btn btn-sm btn-primary">
...
Update Menu
		...
		<div class="help-item">
			<div class="help-title">Kembali ke halaman Menu</div>
			<div class="help-content">
