...
$help	= '<div class="help-container">
		...
		<div class="help-item">
			...
			<div class="help-content">
				<li>Rubah data <b>Usename, User Group, Name, Email </b>sesuai yang diinginkan</li>
			</div>
		</div>
		<div class="help-item">
			<div class="help-title">Status active</div>
			<div class="help-content">
				<li>Pilih <b>Yes</b> pada check active untuk status user aktif</li>
				<li>Pilih <b>No</b> untuk user tidak aktif</li>
			</div>
		</div>
		<div class="help-item">
			<div class="help-title">Change Password</div>
			<div class="help-content">
				<li>Klik Tab Change password kemudian masukkan password baru.</li>
			</div>
		</div>
		<div class="help-item">
