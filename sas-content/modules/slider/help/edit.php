...
$help	= '<div class="help-container">
		...
		<div class="help-item">
			<div class="help-title">Rubah Slider</div>
			<div class="help-content">
				<li>Rubah gambar slider dengan klik icon <a class="red" href="#"><i class="fa fa-trash bigger-110"></i></a></li>
...
<div class="progress-bar progress-bar-warning" style="width: 100%;"></div>
		...
		<div class="help-item">
			...
			<div class="help-content">
				<li>Rubah data Title, Tagline, Description, Caption Button, Link sesuai yang diinginkan</li>
			</div>
		</div>
		<div class="help-item">
