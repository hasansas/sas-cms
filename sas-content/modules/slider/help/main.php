...
$help	= '<div class="help-container">
		...
		<div class="help-item">
			<div class="help-title">Urutan Slider</div>
			<div class="help-content">
				<li>Ubah kolom <b>Order</b> mulai dari 0 untuk slider pertama</li>
				<li>Urutan slider selanjutnya dari nomor terkecil ke besar</li>
			</div>
		</div>
		<div class="help-item">
		...
		<div class="help-item">
			...
			<div class="help-content">
				<li>Beri tanda centang pada kolom publish lalu klik <button class="btn btn-sm btn-primary">Save All Changes</button> untuk menyimpan data</li>
