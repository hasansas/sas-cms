...
$help	= '<div class="help-container">
		...
		<div class="help-item">
			...
			<div class="help-content">
				<li>Isi kolom <b>title</b> untuk judul</li>
				<li>Isi kolom <b>Content</b> untuk isi konten</li>
				<li>Isi kolom <b>Description</b> untuk ringkasan konten</li>
				<li>Isi kolom <b>Tag</b> untuk tagline keyword dengan koma</li>
				<li>Isi kolom <b>Author</b> untuk nama penulis</li>
			</div>
		</div>
		<div class="help-item">
