...
$help	= '<div class="help-container">
		...
		<div class="help-item">
			<div class="help-title">Tambahkan Name/Nama Kategori</div>
		</div>
		<div class="help-item">
			<div class="help-title">Tambahkan Tagline Kategori bila perlu</div>
		</div>
		<div class="help-item">
			<div class="help-title">Tambahkan deskripsi</div>
		</div>
		<div class="help-item">
